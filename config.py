...
color_channels = 3
output_classes = 11     # was 11
counts_as_tap = 0.4
epochs = 30
allowed_ram_mb = 10000      # defines in how many parts the dataset will be split
...
cnn_only_name = cnn_feature_extractor_dir + "preprocessed_inception_v4"
